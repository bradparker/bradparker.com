...
This is the [_Lexicographic order_](https://en.wikipedia.org/wiki/Lexicographic_order), and seems like the way mostly everything is sorted in day to day life.

## Lehmer codes

The example above sorts arrangements with reference to the natural ordering of their elements: the alphabet.
